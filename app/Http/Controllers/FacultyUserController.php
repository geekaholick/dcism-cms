...
class FacultyUserController extends Controller
{
    ...
    {   
        ...
        $data = [
            ['user_id' => $user->user_id, 'privilege_id' => 1, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => $user->user_id, 'privilege_id' => 2, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
    ...
    {
        $existingUser = new User;
        $existingPriv = new user_privileges;
        $existingPriv = user_privileges::Where('user_id', $id)->delete();
